...
/*!
 * \file
 * \copydoc Ewoms::BinaryCoeff::H2O_Air
 */
...
public:
    ...
    { return 1.0/((0.8942+1.47*Ewoms::exp(-0.04394*(temperature-273.15)))*1e-10); }
    ...
    static Evaluation gasDiffCoeff(const Evaluation& temperature, const Evaluation& pressure)
    {
        ...
        return Daw*(pg0/pressure)*Ewoms::pow((temperature/T0),Theta);
    }
