...
/*!
 * \file
 * \copydoc Ewoms::BinaryCoeff::H2O_Mesitylene
 */
...
public:
    ...
    static Evaluation gasDiffCoeff(Evaluation temperature, Evaluation pressure)
    {
        ...
        const Evaluation T_star = Ewoms::max(temperature/T_scal_wm, 1e-5);
        ...
        const Evaluation D_wm = (B_*Ewoms::pow(temperature,1.6)*std::sqrt(Mr))
