...
/*!
 * \file
 * \copydoc Ewoms::DryGasPvt
 */
#ifndef EWOMS_DRY_GAS_PVT_HH
#define EWOMS_DRY_GAS_PVT_HH
...
public:
    ...
    void initFromEclState(const EclipseState& eclState, const Schedule&)
    {
        ...
        for (unsigned regionIdx = 0; regionIdx < numRegions; ++ regionIdx) {
            ...
            Scalar MG = Ewoms::Constants<Scalar>::R*T*rhoRefG / p; // [kg/mol], consequence of the ideal gas law
