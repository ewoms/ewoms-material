...
#include <ewoms/material/eos/pengrobinsonmixture.hh>
...
{
    typedef Ewoms::Spe5FluidSystem<Scalar> ThisType;
...
public:
    ...
    struct ParameterCache : public Ewoms::Spe5ParameterCache<Evaluation, ThisType>
    {};
    ...
    static void init(Scalar minT = 273.15,
                     ...
                     Scalar maxP = 100e6)
    {
        Ewoms::PengRobinsonParamsMixture<Scalar, ThisType, gasPhaseIdx, /*useSpe5=*/true> prParams;
...
template <class Scalar>
const Scalar Spe5FluidSystem<Scalar>::R = Ewoms::Constants<Scalar>::R;
