...
/*!
 * \file
 * \copydoc Ewoms::Spe5ParameterCache
 */
...
#include <ewoms/material/fluidsystems/parametercachebase.hh>

#include <ewoms/material/eos/pengrobinson.hh>
#include <ewoms/material/eos/pengrobinsonparamsmixture.hh>
...
class Spe5ParameterCache
    : public Ewoms::ParameterCacheBase<Spe5ParameterCache<Scalar, FluidSystem> >
{
    typedef Spe5ParameterCache<Scalar, FluidSystem> ThisType;
    typedef Ewoms::ParameterCacheBase<ThisType> ParentType;
...
public:
    ...
    typedef Ewoms::PengRobinsonParamsMixture<Scalar, FluidSystem, oilPhaseIdx, /*useSpe5=*/true> OilPhaseParams;
    //! The cached parameters for the gas phase
    typedef Ewoms::PengRobinsonParamsMixture<Scalar, FluidSystem, gasPhaseIdx, /*useSpe5=*/true> GasPhaseParams;
