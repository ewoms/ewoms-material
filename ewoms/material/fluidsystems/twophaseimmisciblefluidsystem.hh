...
/*!
 * \file
 * \copydoc Ewoms::TwoPhaseImmiscibleFluidSystem
 */
#ifndef EWOMS_TWO_PHASE_IMMISCIBLE_FLUID_SYSTEM_HH
#define EWOMS_TWO_PHASE_IMMISCIBLE_FLUID_SYSTEM_HH
 ...
 * via <tt>Ewoms::LiquidPhase<Component></tt> and
 * <tt>Ewoms::GasPhase<Component></tt>. These phases consist of one pure
...
public:
                           ...
                           unsigned phaseIdx)
    {
        ...
        const auto& temperature = Ewoms::decay<LhsEval>(fluidState.temperature(phaseIdx));
        const auto& pressure = Ewoms::decay<LhsEval>(fluidState.pressure(phaseIdx));
