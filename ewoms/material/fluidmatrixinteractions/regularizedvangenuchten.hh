...
/*!
 * \file
 * \copydoc Ewoms::RegularizedVanGenuchten
 */
...
{
    typedef Ewoms::VanGenuchten<TraitsT, ParamsT> VanGenuchten;
...
public:
    ...
    {
        const auto& Sw = Ewoms::decay<Evaluation>(fs.saturation(Traits::wettingPhaseIdx));
