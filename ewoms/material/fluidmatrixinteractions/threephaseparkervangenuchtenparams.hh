...
/*!
 * \file
 * \copydoc Ewoms::ThreePhaseParkerVanGenuchtenParams
 */
#ifndef EWOMS_THREE_PHASE_PARKER_VAN_GENUCHTEN_PARAMS_HH
#define EWOMS_THREE_PHASE_PARKER_VAN_GENUCHTEN_PARAMS_HH
