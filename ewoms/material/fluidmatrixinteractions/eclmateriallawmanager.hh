...
private:
    ...
    SaturationFunctionFamily getSaturationFunctionFamily(const Ewoms::EclipseState& eclState) const
    {
    ...
    void initThreePhaseParams_(const Ewoms::EclipseState& /* eclState */,
    ...
    Ewoms::EclMultiplexerApproach threePhaseApproach_ = EclMultiplexerApproach::EclDefaultApproach;
    ...
    std::shared_ptr<Ewoms::EclEpsConfig> gasOilConfig;
    std::shared_ptr<Ewoms::EclEpsConfig> oilWaterConfig;
};
} // namespace Ewoms
