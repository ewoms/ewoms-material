...
/*!
 * \file
 * \copydoc Ewoms::EclMultiplexerMaterial
 */
#ifndef EWOMS_ECL_MULTIPLEXER_MATERIAL_HH
#define EWOMS_ECL_MULTIPLEXER_MATERIAL_HH

#include "eclmultiplexermaterialparams.hh"
...
public:
    ...
    typedef Ewoms::EclStone1Material<TraitsT, GasOilMaterialLaw, OilWaterMaterialLaw> Stone1Material;
    typedef Ewoms::EclStone2Material<TraitsT, GasOilMaterialLaw, OilWaterMaterialLaw> Stone2Material;
    typedef Ewoms::EclDefaultMaterial<TraitsT, GasOilMaterialLaw, OilWaterMaterialLaw> DefaultMaterial;
    typedef Ewoms::EclTwoPhaseMaterial<TraitsT, GasOilMaterialLaw, OilWaterMaterialLaw> TwoPhaseMaterial;
