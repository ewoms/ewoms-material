...
struct EclEpsScalingPointsInfo
{
     ...
     */
    void extractUnscaled(const Ewoms::Deck& deck,
                         ...
                         unsigned satRegionIdx)
    {
        ...
        krCriticalEps = Ewoms::ParserKeywords::TOLCRIT::VALUE::defaultValue;
        if (deck.hasKeyword("TOLCRIT")) {
            const Ewoms::DeckKeyword& tolcritKeyword = deck.getKeyword("TOLCRIT");
