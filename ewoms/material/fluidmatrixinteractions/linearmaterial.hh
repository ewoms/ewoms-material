...
public:
                                   ...
                                   const FluidState& state)
    {
        ...
        for (unsigned phaseIdx = 0; phaseIdx < Traits::numPhases; ++phaseIdx) {
            const Evaluation& S =
                Ewoms::decay<Evaluation>(state.saturation(phaseIdx));
    ...
    static Evaluation pcnw(const Params& params, const FluidState& fs)
    {
        ...
        const Evaluation& Sn =
            Ewoms::decay<Evaluation>(fs.saturation(Traits::nonWettingPhaseIdx));
    ...
    {
        const Evaluation& Sg =
            Ewoms::decay<Evaluation>(fs.saturation(Traits::gasPhaseIdx));
