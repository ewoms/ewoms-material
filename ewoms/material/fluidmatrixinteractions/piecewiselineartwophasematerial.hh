...
/*!
 * \file
 * \copydoc Ewoms::PiecewiseLinearTwoPhaseMaterial
 */
#ifndef EWOMS_PIECEWISE_LINEAR_TWO_PHASE_MATERIAL_HH
#define EWOMS_PIECEWISE_LINEAR_TWO_PHASE_MATERIAL_HH
...
private:
                                     ...
                                     const Evaluation& x)
    {
        ...
        size_t segIdx = findSegmentIndex_(xValues, Ewoms::scalarValue(x));
                                      ...
                                      const Evaluation& x)
    {
        ...
        size_t segIdx = findSegmentIndexDescending_(xValues, Ewoms::scalarValue(x));
