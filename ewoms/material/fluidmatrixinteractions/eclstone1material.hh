...
/*!
 * \file
 * \copydoc Ewoms::EclStone1Material
 */
#ifndef EWOMS_ECL_STONE1_MATERIAL_HH
#define EWOMS_ECL_STONE1_MATERIAL_HH

#include "eclstone1materialparams.hh"
                          ...
                          const FluidState& fluidState)
    {
        ...
        if (Sw <= Swco)
            ...
            if (SSw >= 1.0 || SSg >= 1.0)
                ...
                beta = Ewoms::pow( SSo/((1 - SSw)*(1 - SSg)), params.eta());
        }

        return Ewoms::max(0.0, Ewoms::min(1.0, beta*kro_ow*kro_go/krocw));
    }
