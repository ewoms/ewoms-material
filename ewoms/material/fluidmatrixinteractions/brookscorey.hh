...
public:
    ...
    static Evaluation twoPhaseSatPcnw(const Params& params, const Evaluation& Sw)
    {
        ...
        return params.entryPressure()*Ewoms::pow(Sw, -1/params.lambda());
    }
    ...
    static Evaluation twoPhaseSatPcnwInv(const Params& params, const Evaluation& pcnw)
    {
        ...
        return Ewoms::pow(params.entryPressure()/pcnw, -params.lambda());
    }
    ...
    static Evaluation twoPhaseSatSw(const Params& params, const Evaluation& pc)
    {
        ...
        return Ewoms::pow(pc/params.entryPressure(), -params.lambda());
    }
    ...
    static Evaluation twoPhaseSatKrw(const Params& params, const Evaluation& Sw)
    {
        ...
        return Ewoms::pow(Sw, 2.0/params.lambda() + 3.0);
    }

    template <class Evaluation>
    static Evaluation twoPhaseSatKrwInv(const Params& params, const Evaluation& krw)
    {
        return Ewoms::pow(krw, 1.0/(2.0/params.lambda() + 3.0));
    }
    ...
    static Evaluation twoPhaseSatKrn(const Params& params, const Evaluation& Sw)
    {
        ...
        return Sn*Sn*(1. - Ewoms::pow(Sw, exponent));
    }
