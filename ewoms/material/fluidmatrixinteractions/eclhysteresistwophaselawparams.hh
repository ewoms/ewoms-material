...
/*!
 * \file
 * \copydoc Ewoms::EclHysteresisTwoPhaseLawParams
 */
#ifndef EWOMS_ECL_HYSTERESIS_TWO_PHASE_LAW_PARAMS_HH
#define EWOMS_ECL_HYSTERESIS_TWO_PHASE_LAW_PARAMS_HH

#include "eclhysteresisconfig.hh"
