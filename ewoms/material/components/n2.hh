...
public:
    ...
    static Evaluation vaporPressure(const Evaluation& temperature)
    {
        ...
        const Evaluation& sqrtSigma = Ewoms::sqrt(sigma);
        ...
        return
            criticalPressure() *
            Ewoms::exp(criticalTemperature()/temperature*
                         (sigma*(N1 +
                                 sqrtSigma*N2 +
                                 sigma*(sqrtSigma*N3 +
    ...
    static Evaluation gasViscosity(const Evaluation& temperature, const Evaluation& /*pressure*/)
    {
        ...
        const Evaluation& mu = 40.785*Fc*Ewoms::sqrt(M*temperature)/(std::pow(Vc, 2./3)*Omega_v);
