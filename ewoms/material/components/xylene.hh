...
public:
    ...
    static Evaluation vaporPressure(const Evaluation& temperature)
    {
        ...
        return 100*1.334*Ewoms::pow(10.0, (A - (B/(temperature - 273.15 + C))));
    }
    ...
    {
        temperature = Ewoms::min(temperature, criticalTemperature()); // regularization
        temperature = Ewoms::max(temperature, 0.0); // regularization
    ...
    static Evaluation molarLiquidDensity(Evaluation temperature, const Evaluation& /*pressure*/)
    {
        ...
        temperature = Ewoms::max(temperature, 250.0); // regularization
        ...
        return 1.0/(A2*Ewoms::pow(A1, expo));
    }
    ...
    static Evaluation gasViscosity(Evaluation temperature, const Evaluation& /*pressure*/)
    {
        ...
        const Evaluation& Tr = Ewoms::max(temperature/criticalTemperature(), 1e-10);
        const Scalar Fp0 = 1.0;
        const Scalar xi = 0.004623;
        const Evaluation& eta_xi = Fp0*(0.807*Ewoms::pow(Tr, 0.618)
